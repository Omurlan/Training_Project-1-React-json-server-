...
const INIT_STATE = {
    ...
    productDetails: null,
    searchProducts: [],
    productsCountInCart: JSON.parse(localStorage.getItem('watchCart')) ? JSON.parse(localStorage.getItem('watchCart')).products.length : 0,
    productsCountInFavorite: JSON.parse(localStorage.getItem('watchfavorite')) ? JSON.parse(localStorage.getItem('favorite')).products.length : 0,
    cartData: {},
    favoriteData: {},
    filterProduct: [],
    comments: [],
...
const AdminContextProvider = ({ children }) => {
    ...
    function deleteFromCart(id) {
        ...
        let newData = JSON.parse(localStorage.getItem("watchCart"))
        dispatch({
    ...
    function getFavorite() {
        let favorite = JSON.parse(localStorage.getItem('watchFavorite'))
        dispatch({
            type: 'GET_FAVORITE',
            payload: favorite
        })
    ...
    function addAndDeleteProductInFavorite(product) {
        ...
        localStorage.setItem('watchFavorite', JSON.stringify(favorite))
